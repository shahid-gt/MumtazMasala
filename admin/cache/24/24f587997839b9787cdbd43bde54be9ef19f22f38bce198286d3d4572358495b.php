...
/* widget.html */
class __TwigTemplate_f1ab029d8642dbcf4a85bc10159a79c06a709ea0b17ca8b572867bb71fbb4374 extends Twig_Template
{
    public function __construct(Twig_Environment $env)
    {
        ...
        // line 1
        $this->parent = $this->loadTemplate("layout.html", "widget.html", 1);
        $this->blocks = array(
...
\t\t\t\t\t\t<label class=\"col-lg-2 control-label\" for=\"sub_title\">Sub Title</label>
\t\t\t\t\t\t<div class=\"col-lg-10\">
\t\t\t\t\t\t\t<input class=\"form-control\" maxlength=\"250\" name=\"sub_title\" id=\"sub_title\" autocomplete=\"off\" required type=\"text\" value=\"";
            // line 49
            echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($this->getAttribute((isset($context["web"]) ? $context["web"] : null), "fields", array()), "sub_title", array()), "value", array()), "html", null, true);
            echo "\" />
\t\t\t\t\t\t</div>
\t\t\t\t\t</div>
\t\t\t\t\t<div class=\"form-group\">
...
\t";
    ...
    {
        return array (  221 => 90,  215 => 86,  209 => 82,  207 => 81,  202 => 79,  197 => 78,  194 => 77,  190 => 76,  179 => 68,  172 => 64,  160 => 55,  151 => 49,  142 => 43,  137 => 40,  131 => 38,  129 => 37,  123 => 34,  118 => 32,  113 => 30,  108 => 28,  104 => 27,  100 => 26,  96 => 25,  92 => 24,  88 => 23,  80 => 17,  74 => 14,  70 => 13,  66 => 12,  62 => 11,  58 => 10,  54 => 9,  49 => 8,  47 => 7,  44 => 6,  38 => 4,  33 => 3,  30 => 2,  11 => 1,);
    }
}
/* {% extends "layout.html" %}*/
/* 	{% block headerscript %}*/
...
/* 						<label class="col-lg-2 control-label" for="sub_title">Sub Title</label>*/
/* 						<div class="col-lg-10">*/
/* 							<input class="form-control" maxlength="250" name="sub_title" id="sub_title" autocomplete="off" required type="text" value="{{ web.fields.sub_title.value }}" />*/
/* 						</div>*/
/* 					</div>*/
/* 					<div class="form-group">*/
/* 						<label class="col-lg-2 control-label" for="url">URL</label>*/
